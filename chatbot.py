# -*- coding: utf-8 -*-
"""
Created on Sat Dec 14 05:26:03 2019
...
#creating a dictionary that maps exach word to its number of occurences
word2count = {}
...
def apply_padding(batch_of_sequences, word2int):
    max_sequence_length = max([len(sequence)for sequence in batch_of_sequences])#error
    return[sequence + [word2int['<PAD>']] * (max_sequence_length - len(sequence)) for sequence in batch_of_sequences]
#Splitting the data into batches of questions and answers
def split_into_batched(questions,answers, batch_size):
    for batch_index in range(0, len(questions) // batch_size):
        start_index = batch_index * batch_size
        questions_ins_batch = question
#Splitting the data into batches of questions and answers
...
#Splittting the questions and answers into training and validation sets
